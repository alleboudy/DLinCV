...
def create_posenet(weights_path=None):
    ...
    norm1 = tf.nn.local_response_normalization(pool1, depth_radius=5, bias=1,alpha=0.0001,beta=0.75, name='norm1')
    ...
    norm2 = tf.nn.local_response_normalization(conv2, depth_radius=5, bias=1,alpha=0.0001,beta=0.75, name='conv2')
...
if __name__ == "__main__":
    ...
    model = create_posenet('googlenet_weights.h5')
