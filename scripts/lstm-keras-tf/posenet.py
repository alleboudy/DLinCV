...
def create_posenet(weights_path=None):
    ...
    inception_3a_output =TimeDistributed( merge([inception_3a_1x1, inception_3a_3x3, inception_3a_5x5,
                                 inception_3a_pool_proj], mode='concat', concat_axis=1, name='inception_3a/output'))

    inception_3b_1x1 = Convolution2D(128, 1, 1, border_mode='same', activation='relu',
    ...
    inception_3b_3x3 = Convolution2D(192, 3, 3, border_mode='same', activation='relu',
    ...
    inception_3b_5x5 = Convolution2D(96, 5, 5, border_mode='same', activation='relu',
    ...
    inception_3b_output = merge([inception_3b_1x1, inception_3b_3x3, inception_3b_5x5,
                                 inception_3b_pool_proj], mode='concat', concat_axis=1, name='inception_3b/output')
    ...
    inception_4a_1x1 = Convolution2D(192, 1, 1, border_mode='same', activation='relu',
    ...
    inception_4a_3x3 = Convolution2D(208, 3, 3, border_mode='same', activation='relu',
    ...
    inception_4a_5x5 = Convolution2D(48, 5, 5, border_mode='same', activation='relu',
    ...
    inception_4a_output = merge([inception_4a_1x1, inception_4a_3x3, inception_4a_5x5,
                                 inception_4a_pool_proj], mode='concat', concat_axis=1, name='inception_4a/output')

    loss1_ave_pool = AveragePooling2D(pool_size=(5, 5), strides=(
        3, 3), name='loss1/ave_pool')(inception_4a_output)

    loss1_conv = Convolution2D(128, 1, 1, border_mode='same', activation='relu',
    ...
    cls1_fc_pose_xyz = Dense(3, name='cls1_fc_pose_xyz',
                             W_regularizer=l2(0.0002))(loss1_drop_fc)

    cls1_fc_pose_wpqr = Dense(
...
#    loss1_classifier_act = Activation('softmax')(loss1_classifier)
    ...
    inception_4b_1x1 = Convolution2D(160, 1, 1, border_mode='same', activation='relu',
    ...
    inception_4b_3x3 = Convolution2D(224, 3, 3, border_mode='same', activation='relu',
    ...
    inception_4b_5x5 = Convolution2D(64, 5, 5, border_mode='same', activation='relu',
    ...
    inception_4b_output = merge([inception_4b_1x1, inception_4b_3x3, inception_4b_5x5,
                                 inception_4b_pool_proj], mode='concat', concat_axis=1, name='inception_4b_output')

    inception_4c_1x1 = Convolution2D(128, 1, 1, border_mode='same', activation='relu',
    ...
    inception_4c_3x3 = Convolution2D(256, 3, 3, border_mode='same', activation='relu',
    ...
    inception_4c_5x5 = Convolution2D(64, 5, 5, border_mode='same', activation='relu',
    ...
    inception_4c_output = merge([inception_4c_1x1, inception_4c_3x3, inception_4c_5x5,
                                 inception_4c_pool_proj], mode='concat', concat_axis=1, name='inception_4c/output')

    inception_4d_1x1 = Convolution2D(112, 1, 1, border_mode='same', activation='relu',
    ...
    inception_4d_3x3 = Convolution2D(288, 3, 3, border_mode='same', activation='relu',
    ...
    inception_4d_5x5 = Convolution2D(64, 5, 5, border_mode='same', activation='relu',
    ...
    inception_4d_output = merge([inception_4d_1x1, inception_4d_3x3, inception_4d_5x5,
                                 inception_4d_pool_proj], mode='concat', concat_axis=1, name='inception_4d/output')

    loss2_ave_pool = AveragePooling2D(pool_size=(5, 5), strides=(
        3, 3), name='loss2/ave_pool')(inception_4d_output)

    loss2_conv = Convolution2D(128, 1, 1, border_mode='same', activation='relu',
    ...
    cls2_fc_pose_xyz = Dense(3, name='cls2_fc_pose_xyz',
                             W_regularizer=l2(0.0002))(loss2_drop_fc)

    cls2_fc_pose_wpqr = Dense(
